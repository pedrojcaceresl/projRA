...
export default function ARExperience({ modelId, getModelPath, modelPath }: ARViewerProps) {
	...
	useEffect(() => {
		...
		// Loader FBX
		exp.loader = new GLTFLoader();
		const dracoLoader = new DRACOLoader();
		dracoLoader.setDecoderPath("/draco/"); // ajusta según tu estructura
		exp.loader.setDRACOLoader(dracoLoader);
